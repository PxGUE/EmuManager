        ...
        ColumnLayout {
            ...
            ColumnLayout {
                    ...
                    Row {
                        ...
                        Button {
                            ...
                            background: Rectangle { 
                                radius: 0
                                color: subFavBtn.hovered ? "#33ffffff" : "transparent"
                        ...
                        Button {
                            ...
                            background: Rectangle { 
                                radius: 0
                                color: subEditBtn.hovered ? "#33ffffff" : "transparent"
                ...
                RowLayout {
                    ...
                    Column { 
                        spacing: 2
                        Label { text: tr("lib_developer"); color: "#66ffffff"; font.pixelSize: 10; font.bold: true }
                    ...
                    Column { 
                        spacing: 2
                        Label { text: tr("lib_played"); color: "#66ffffff"; font.pixelSize: 10; font.bold: true }
                ...
                Button {
                    ...
                    background: Rectangle {
                        radius: 0
                        color: "transparent"
                        border.color: megaPlayBtn.hovered ? root.accentColor : "#44ffffff"
